(function extract() {
    ...
    function createModal() {
        ...
        const numberOfItems = document.querySelector('.mini-cart-container').getAttribute('data-quantity');
        ...
        descriptionDiv.innerHTML = `Cart quantity: ${numberOfItems}`;
    ...
    document.addEventListener('scroll', modalControl);
})();
